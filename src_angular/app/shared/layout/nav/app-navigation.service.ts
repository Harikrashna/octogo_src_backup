        ...
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [], [
                ...
                new AppMenuItem('Master', 'Pages.Administration.Master', 'flaticon-settings', '',[],[
                    ...
                    new AppMenuItem('AwbCostApproach', 'Pages.Administration.AwbCostApproach', 'fa fa-file', '/app/admin/master/awb-cost-approach'),
                    new AppMenuItem('Product', 'Pages.Administration.Product' , 'flaticon-folder-1', '/app/admin/master/product'),
