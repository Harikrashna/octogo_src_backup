...
using CF.Octogo.Commands;
using CF.Octogo.Core.Threading;
using CF.Octogo.Models.NavigationMenu;
using CF.Octogo.Services.Navigation;
...
using CF.Octogo.ApiClient;
using CF.Octogo.Controls;
using CF.Octogo.Dto;
using CF.Octogo.Extensions;
using CF.Octogo.Localization;
using CF.Octogo.UI;
using CF.Octogo.UI.Assets;
using CF.Octogo.Views;
using DependencyResolver = CF.Octogo.Core.Dependency.DependencyResolver;
...
namespace CF.Octogo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Octogo";
