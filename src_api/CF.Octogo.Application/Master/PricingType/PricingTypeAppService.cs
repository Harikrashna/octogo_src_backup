...
namespace CF.Octogo.Master.PricingType
{
    ...
    public class PricingTypeAppService : OctogoAppServiceBase, IPricingTypeAppService
    {
        ...
        public async Task<PagedResultDto<PricingTypeListDto>> GetPricingType(PricingListInputDto input)
        {
            ...
            "USP_GetPricingTypesList", parameters ); // Change procedure name "USP_GetPricingTypebyId" to "USP_GetPricingTypesListOrPricingTypeForEdit"
            if (ds.Tables.Count > 0)
            {
                var totalCount = 0;
                var pricingTypeList = SqlHelper.ConvertDataTable<PricingTypeListDto>(ds.Tables[0]);
