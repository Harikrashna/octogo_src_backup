...
using CF.Octogo.Authentication.TwoFactor.Google;
using CF.Octogo.Authorization.Users.Dto;
using CF.Octogo.Authorization.Users.Profile.Cache;
using CF.Octogo.Authorization.Users.Profile.Dto;
using CF.Octogo.Configuration;
using CF.Octogo.Friendships;
using CF.Octogo.Gdpr;
using CF.Octogo.Net.Sms;
using CF.Octogo.Security;
...
{
    [AbpAuthorize]
    public class ProfileAppService : OctogoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CF.Octogo",
