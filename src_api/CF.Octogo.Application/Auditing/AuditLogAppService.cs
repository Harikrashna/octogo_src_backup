...
using CF.Octogo.Auditing.Exporting;
using CF.Octogo.Authorization;
using CF.Octogo.Authorization.Users;
using CF.Octogo.Dto;
using CF.Octogo.EntityHistory;
using EntityHistoryHelper = CF.Octogo.EntityHistory.EntityHistoryHelper;

namespace CF.Octogo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : OctogoAppServiceBase, IAuditLogAppService
    {
