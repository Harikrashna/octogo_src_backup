...
using CF.Octogo.Migrations.Seed;
using CF.Octogo.Migrations.Seed.Host;
...
namespace CF.Octogo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : OctogoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<OctogoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{OctogoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{OctogoConsts.ConnectionStringName}", constring);
        }
