...
using CF.Octogo.DemoUiComponents.Dto;

namespace CF.Octogo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : OctogoAppServiceBase, IDemoUiComponentsAppService
    {
