...
namespace CF.Octogo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : OctogoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CF.Octogo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
