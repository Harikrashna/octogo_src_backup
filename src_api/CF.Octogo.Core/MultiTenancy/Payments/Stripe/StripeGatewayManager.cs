...
{
    public class StripeGatewayManager : OctogoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Octogo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + OctogoConsts.Currency;
        }
