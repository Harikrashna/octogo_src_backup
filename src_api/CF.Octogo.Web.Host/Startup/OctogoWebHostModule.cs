...
{
    [DependsOn(
        typeof(OctogoWebCoreModule)
    )]
    public class OctogoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public OctogoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OctogoWebHostModule).GetAssembly());
        }
