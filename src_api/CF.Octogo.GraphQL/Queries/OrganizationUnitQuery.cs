...
using CF.Octogo.Core.Base;
using CF.Octogo.Core.Extensions;
using CF.Octogo.Dto;
using CF.Octogo.Types;

namespace CF.Octogo.Queries
{
    public class OrganizationUnitQuery : OctogoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
