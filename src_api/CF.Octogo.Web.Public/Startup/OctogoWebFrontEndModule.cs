...
namespace CF.Octogo.Web.Public.Startup
{
    ...
    public class OctogoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public OctogoWebFrontEndModule(IWebHostEnvironment env, OctogoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(OctogoWebFrontEndModule).GetAssembly());
        }
    }
}
