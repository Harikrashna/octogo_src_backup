...
namespace CF.Octogo.Web.Authentication.JwtBearer
{
    public class OctogoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public OctogoJwtSecurityTokenHandler()
        {
